...
This script sets up and run the fitting routine.
...
savepath = '/jansky/cronin/ngc253/NW/'
save_fits_num = 100
...
# file names
filename = '/jansky/cronin/ngc253/data/ADP.2019-08-24T09_53_08.548.fits'
vel_model = '/jansky/cronin/ngc253/data/ngc253_nw_halpha_vel_model_smooth.fits'
